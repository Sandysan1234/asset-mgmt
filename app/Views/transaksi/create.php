...
<script src="https://code.jquery.com/ui/1.13.2/jquery-ui.min.js"></script> -->
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="/transaksi/save" method="post" enctype="multipart/form-data" class="row g-3">
                  <?= csrf_field(); ?>
                          ...
                          <div class="col-12">
                            ...
                            <select id="user_kabag_asal" name="user_kabag_asal" required class="form-select <?= (validation_show_error('user_kabag_asal')) ? 'is-invalid' : ''; ?>">
                              ...
                              <?php foreach ($kabagUsers as $user): ?>
                                <option value="<?= $user->id ?>" <?= old('user_kabag_asal') == $user->id ? 'selected' : ''; ?>>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="form-check form-switch custom-switch-v1 my-3">
                          <input class="form-check-input" type="checkbox" role="switch"
                            id="ack_fin" name="ack_fin" <?= has_permission('ttd_finance') ? '' : 'disabled' ?>>
                  ...
                  <div class="col-md-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="form-check form-switch custom-switch-v1 my-3">
                          <input class="form-check-input" type="checkbox" role="switch"
                            id="ack_acc" name="ack_acc" <?= has_permission('ttd_accounting') ? '' : 'disabled' ?>>
                  ...
                  <div class="col-md-4">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="form-check form-switch custom-switch-v1 my-3">
                          <input class="form-check-input" type="checkbox" role="switch"
                            id="ack_ctrl" name="ack_ctrl" <?= has_permission('ttd_controlling') ? '' : 'disabled' ?>>
    ...
    <script>
      function previewimg() {
        ...
        fileUpload.readAsDataURL(upload.files[0]);
